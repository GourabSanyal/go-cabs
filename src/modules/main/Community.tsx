        ...
        {new Array(5).fill('').map((item, i) => (
          <View key={i} style={styles.card}>
            ...
            <Text style={styles.h2}>
              Life in motion, one ride at a time. Whether it’s a quick commute,
              chasing dreams, or making memories, we’re here to get you there
              smoothly and safely.
            </Text>
            <Text
              style={[
            ...
            <View style={{width: '100%'}}>
              <Image
                source={require('../../../assets/images/comunity-cars.png')}
