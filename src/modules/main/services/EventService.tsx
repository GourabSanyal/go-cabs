...
import BackButton from '@/modules/main/common/BackButton';

const EventService = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Event Services</Text>
      <Text style={styles.h3}>
        Arrive in style, on time, and stress-free to every event with our
        reliable and smooth rides
      </Text>
      <Margin margin={30} />
          ...
          return (
            <TouchableOpacity
              ...
              <LinearGradient
                ...
                {/* {item.icon} */}
                <Text style={styles.h4}>EV {item.title}</Text>
              </LinearGradient>
            </TouchableOpacity>
          );
        })}
