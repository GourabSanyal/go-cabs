        ...
        <>
          <View style={styles.card}>
            ...
            <View style={styles.innerCard}>
              ...
              <View style={{flex: 1, gap: 10}}>
                <View
                  ...
                  <Text style={styles.h3}>Bangalore Fort, Bangalore,</Text>
                  <Text
                    style={[
                      styles.h3,
                      {
                ...
                <View
                  ...
                  <Text
                    style={[
                      styles.h3,
                      {fontFamily: 'Montserrat-SemiBold', color: primaryColor},
                    ]}>
                    ₹162
                  </Text>
                </View>
            ...
            <View style={styles.cardBottom}>
              <Text style={[styles.h3, {fontFamily: 'Montserrat-SemiBold'}]}>
